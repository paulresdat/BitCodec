...
#[cfg(test)]
mod encoder_tests {
    use crate::encoder::bitwise_ops::get_bits_left_pad;
    ...
    fn can_read_bits_in_a_stream_of_bytes() {
        ...
        let new_b = get_bits_left_pad(&bytes, 0, 15);
        // note, this is without reversal
        assert_eq!(new_b[0], 0b0011_0011);
        assert_eq!(new_b[1], 0b0011_1111);
    
        let new_b = get_bits_left_pad(&bytes, 1, 14);
        assert_eq!(new_b[0], 0b1001_1001);
        assert_eq!(new_b[1], 0b0001_1111);
